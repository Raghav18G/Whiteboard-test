...
(function download() {
  ...
  function downloadOption() {
    setObjectValue("Download", true, "start");
  ...
  Tools.add({
    ...
    <div class="tool-selected">
        <img class="tool-img" src="assets/save.svg" alt="save Icon">
    </div>
    <label id="tool-save-localization" class="label-save" style="font-size:10px;line-height: 2px;font-weight:400; margin-top: 14px;">Save</label>
    `,
    oneTouch: true,
    isExtra: false,
