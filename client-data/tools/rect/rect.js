...
(function () {
  ...
  Tools.add({
    ...
    // "name": "Rectangle",
    //  "icon": "▢",
    iconHTML: `<div style="display:flex; position:relative; margin-left:1rem; padding-bottom:8px;"> <div id="shapesArrow" style="display:none;position:absolute; top:-20px; left:-11px;">${arrowSvg}</div> ${shapeSVG}</div>`,
    name: "Rectangle",
    title: "Shapes",
    listeners: {
      press: start,
